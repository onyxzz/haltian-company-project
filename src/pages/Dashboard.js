...
export const Dashboard = ({ historyData }) => {
  ...
  const co2Style = co2Alert
    ? { background: co2Alert.index, color: "white" }
    : null
  const tvocAlert = alerts.find((alert) => alert.element.includes("tvoc"))
  const tvocStyle = tvocAlert
    ? { background: tvocAlert.index, color: "white" }
    : null
  const tempAlert = alerts.find((alert) =>
    alert.element.includes("temperature")
  )
  const tempStyle = tempAlert
    ? { background: tempAlert.index, color: "white" }
    : null
      ...
      <div className="pt-4 px-32 h-screen">
        ...
        <div className="flex justify-between mb-16 h-[50%]">
          <div className="bg-white rounded-xl flex flex-col w-[30%] justify-around">
            ...
            <div
              className="text-center text-light-purple text-3xl font-semibold"
              style={qualityStyle}
            >
              {quality || "Analyzing"}
            </div>
          ...
          <div className="w-[30%]">
            ...
            >
              ...
              <div>
                <div
                  className="text-3xl text-light-purple font-medium pt-4 pb-4"
                  style={co2Style}
                >
                  Carbon Dioxide
                </div>
        ...
        <div className="flex justify-between h-[40%]">
          <div className="w-[35%] rounded-xl flex flex-col justify-between ">
            ...
            <div
              ...
              className="p-8 text-3xl text-black font-semibold bg-[#C3CAFF] rounded-xl"
            >
              <div
                style={{
                  height: "auto",
